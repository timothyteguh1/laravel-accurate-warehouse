...
<head>
    ...
    <style>
        ...
        .brand {
            ...
            padding: 0 24px 30px; display: flex; align-items: center; gap: 10px;
        }
        .nav-link {
            display: flex; align-items: center; gap: 12px;
            padding: 12px 24px; color: #6B7280; font-weight: 500;
            transition: 0.2s;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a href="{{ url('/scan-so') }}" class="nav-link {{ Request::is('scan-so*') ? 'active' : '' }}">
    ...
    <div class="main">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="bg-dark text-white rounded-circle d-flex justify-content-center align-items-center" style="width: 40px; height: 40px;">
